...
imageToDisp = './scenes/photo_7.jpg'
photo_width = 4608 * 2 ##640 
photo_height = 2592  #240 #
image_height = 2592 #240 #
image_width = 4608  #320 #
...
def stereo_depth_map(rectified_pair):
    ...
    #print(dmLeft[120,160], dmRight[120,160])
    #print('@@@', np.array_equal(dmLeft, dmRight))
    #cv2.FindStereoCorrespondenceBM(dmLeft, dmRight, disparity, sbm)
    disparity = sbm.compute(dmLeft, dmRight)
    #print('....', np.all(disparity==-416))
